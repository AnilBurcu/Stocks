...
class StockDetailsViewController: UIViewController {
    ...
    private func setUpTable() {
        ...
        tableView.tableHeaderView = UIView(frame: CGRect(x: 0, y: 0, width: view.width, height: (view.width * 0.7) + 100)) //Table view üzerine view ekleyerek ekranı böldük
    }
...
extension StockDetailsViewController: UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        // Sadece watchlistte zaten yoksa ekle butonu göstermek için  persistent managerden fonkisyon yazdık
...
extension StockDetailsViewController: NewsHeaderViewDelegate {
    func newsHeaderViewdidTapAddButton(_ headerView: NewsHeaderView) {
        ...
        let alert = UIAlertController(title: "Added to your Watchlist", message: "We've added \(companyName) to your watchlist", preferredStyle: .alert)
